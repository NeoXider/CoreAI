...
персистентность. Проверено: EditMode 3204 / 3195 прошло / 0 падений / 9 пропусков; PlayMode на
`ling-3.0-tiny` 113 / 110 / 0 / 3 пропуска по плану; Node-тесты jslib 6/6 и SSE 12/12.

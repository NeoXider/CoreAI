namespace CoreAI.Ai
{
    ...
    internal static class BuiltInAgentSystemPromptTexts
    {
        ...
        internal const string Programmer =
            ...
            "coreai_world_spawn, coreai_world_move, coreai_world_rotate, coreai_world_set_transform, coreai_world_destroy, coreai_world_parent, and coreai_world_set_props for world changes. Call logic_list() when unsure which rule slots exist. " +

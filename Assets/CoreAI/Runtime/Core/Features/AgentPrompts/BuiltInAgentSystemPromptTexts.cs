namespace CoreAI.Ai
{
    ...
    internal static class BuiltInAgentSystemPromptTexts
    {
        ...
        internal const string Programmer =
            ...
            "For night, find a Light and set Light.intensity through unity_set_member; do not call game.time or set_game_setting. For visible spawns, call coreai_world_list_prefabs first, then coreai_world_spawn/coreai_world_spawn_batch with a real prefab key; report() alone is not a spawn. " +

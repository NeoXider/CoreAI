...
- `Instance.new(""Class""[, parent])` — creatable classes are ""Part"", ""Folder"", ""Model"",
  ""ClickDetector"", ""RemoteEvent"", ""UnreliableRemoteEvent"", ""RemoteFunction"". Any other name
...
- `game:GetService(""Name"")` — the standard runtime has live tree-backed `Workspace`, `Lighting`,
  ...
  `HttpService`, `UserInputService`, and `RunService` services.
...
`Shape` (Enum.PartType), `Material` (Enum.Material), `Orientation` and `Rotation` (Vector3 of
...
`Material` accepts any of the 45 `Enum.Material` items and all 45 render. Brick, Wood,
WoodPlanks, Grass, Cobblestone and Metal use textured PBR surfaces; the rest are procedural.

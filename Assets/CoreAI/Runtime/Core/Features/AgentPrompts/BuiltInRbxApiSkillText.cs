...
- `Instance.new(""Class""[, parent])` — creatable classes are ONLY ""Part"", ""Folder"", ""Model"".
  ...
  configuring instead.
- `game:GetService(""Name"")` — valid services: Workspace, ReplicatedStorage, ServerStorage,
  ServerScriptService, StarterPlayer. Unknown name -> ""X is not a valid Service name"".

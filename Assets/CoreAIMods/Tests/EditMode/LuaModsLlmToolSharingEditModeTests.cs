...
namespace CoreAI.Tests.EditMode
{
    ...
    /// <see cref="LuaModRuntime"/> wired with a fake <see cref="ILuaModSourceStore"/> and managed by a
    ...
    public sealed class LuaModsLlmToolSharingEditModeTests
    {
        ...
        public async Task Export_Import_Forget_SharesModBetweenRuntimes()
        {
            ...
            LuaModRuntime destination = new(new StubBindings(), sourceStore: destStore);

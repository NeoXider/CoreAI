...
namespace CoreAI.Tests.EditMode.RbxApi.Unity
{
    ...
    public sealed class RbxMaterialTextureCatalogEditModeTests
    {
        ...
        private static readonly KeyValuePair<string, string>[] ConfirmedAmbientCgMappings =
        {
            ...
            new("Metal", "Metal063"),
            new("Grass", "Grass005"),
            new("Pavement", "PavingStones131"),
            new("Pebble", "Gravel023"),
            new("CeramicTiles", "Tiles131"),
            new("LeafyGrass", "Moss002"),
            new("Mud", "Ground038"),
            new("Ground", "Ground037"),
            new("ClayRoofTiles", "RoofingTiles014A"),
            new("RoofShingles", "RoofingTiles012A"),
            new("Fabric", "Fabric030"),
            new("Carpet", "Carpet013"),
            new("Leather", "Leather037"),
            new("Slate", "Rock050"),
            new("Sandstone", "Rock035"),
            new("Limestone", "Rock030"),
            new("Granite", "Granite001A"),
            new("Basalt", "Rock053"),
            new("Concrete", "Concrete034"),
            new("Asphalt", "Asphalt025A"),
            new("Snow", "Snow010A"),
            new("Sand", "Ground054"),
            new("Marble", "Marble012"),
            new("Cardboard", "Cardboard004"),
            new("Plaster", "Plaster003"),
            new("Rubber", "Rubber004"),
            new("CorrodedMetal", "Rust004"),
            new("DiamondPlate", "MetalPlates006"),
            new("CrackedLava", "Lava004"),
            new("Ice", "Ice002"),
            new("Salt", "Concrete020")
        };

...
namespace CoreAI.Tests.EditMode.RobloxApi.Datatypes
{
    ...
    public sealed class RobloxDatatypesFitnessEditModeTests
    {
        ...
        private static string RobloxApiRoot =>
            Path.Combine(Application.dataPath, "CoreAIMods", "Runtime", "RobloxApi");
        ...
        public void DatatypesAsmdef_DeclaresEngineFreeDomain()
        {
            string asmdefPath = Path.Combine(
                RobloxApiRoot, "Datatypes", "CoreAI.RobloxApi.Datatypes.asmdef");
        ...
        {
            var assembly = typeof(CoreAI.Mods.Roblox.Datatypes.RbxVector3).Assembly;
            ...
            Assert.IsEmpty(unityRefs,
                "CoreAI.RobloxApi.Datatypes must not link any Unity assembly: " +

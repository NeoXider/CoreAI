...
namespace CoreAI.Mods.Rbx.Datatypes
{
    ...
    public readonly struct RbxVector3 : IEquatable<RbxVector3>
    {
        ...
        public static RbxVector3 Zero => new(0f, 0f, 0f);
        public static RbxVector3 One => new(1f, 1f, 1f);
        public static RbxVector3 XAxis => new(1f, 0f, 0f);
        public static RbxVector3 YAxis => new(0f, 1f, 0f);
        public static RbxVector3 ZAxis => new(0f, 0f, 1f);
        ...
        public float Dot(RbxVector3 other)
        {
            return X * other.X + Y * other.Y + Z * other.Z;
        }

        public RbxVector3 Cross(RbxVector3 other)
        {
        ...
        public RbxVector3 Lerp(RbxVector3 goal, float alpha)
        {
            return new RbxVector3(
                X + (goal.X - X) * alpha,
                Y + (goal.Y - Y) * alpha,
        ...
        public RbxVector3 Abs()
        {
            return new RbxVector3(MathF.Abs(X), MathF.Abs(Y), MathF.Abs(Z));
        }

        public RbxVector3 Ceil()
        {
            return new RbxVector3(MathF.Ceiling(X), MathF.Ceiling(Y), MathF.Ceiling(Z));
        }

        public RbxVector3 Floor()
        {
            return new RbxVector3(MathF.Floor(X), MathF.Floor(Y), MathF.Floor(Z));
        }

        public RbxVector3 Sign()
        {
            return new RbxVector3(MathF.Sign(X), MathF.Sign(Y), MathF.Sign(Z));
        }

        public RbxVector3 Max(params RbxVector3[] others)
        {
            RbxVector3 result = this;
        ...
        {
            return new RbxVector3(a.X + b.X, a.Y + b.Y, a.Z + b.Z);
        }
        ...
        public static RbxVector3 operator -(RbxVector3 a)
        {
            return new RbxVector3(-a.X, -a.Y, -a.Z);
        }
        ...
        public static RbxVector3 operator *(RbxVector3 a, float s)
        {
            return new RbxVector3(a.X * s, a.Y * s, a.Z * s);
        }

        public static RbxVector3 operator *(float s, RbxVector3 a)
        {
            return a * s;
        }
        ...
        {
            return new RbxVector3(MathF.Floor(X / s), MathF.Floor(Y / s), MathF.Floor(Z / s));
        }

        /// <summary>Lua `//` floor division component-wise.</summary>
        public RbxVector3 FloorDivide(RbxVector3 b)
        {
            return new RbxVector3(MathF.Floor(X / b.X), MathF.Floor(Y / b.Y), MathF.Floor(Z / b.Z));
        }

        public static bool operator ==(RbxVector3 a, RbxVector3 b)
        {
            return a.Equals(b);
        }
        ...
        public bool Equals(RbxVector3 other)
        {
            return X == other.X && Y == other.Y && Z == other.Z;
        }
        ...
        {
            return obj is RbxVector3 v && Equals(v);
        }

...
namespace CoreAI.ExampleGame.ArenaProgression.Infrastructure
{
    ...
    {
        [SerializeField]
        private LevelCurveDefinition sessionLevelCurve;

        [SerializeField]
        private LevelCurveDefinition metaLevelCurve;

        [SerializeField]
        private int baseXpPerKill = 10;

        [SerializeField]
        private bool divideXpByAliveTeamMembers = true;

        [SerializeField]
        private int startChoiceCount = 3;

        [SerializeField]
        private int maxChoiceCount = 5;

        [SerializeField]
        private float draftTimeScale = 0f;

        [SerializeField]
        private float commonStatMult = 1f;

        [SerializeField]
        private float rareStatMult = 1.5f;

        [SerializeField]
        private float epicStatMult = 2f;

        [SerializeField]
        private float legendaryStatMult = 3f;

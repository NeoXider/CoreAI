...
namespace CoreAI.ExampleGame.ArenaSurvival.Domain
{
    ...
    public class ArenaDirectorSettings : ScriptableObject
    {
        ...
        [Header("Сложность волн (VS-style)")]
        [Tooltip(
            "Нелинейная кривая: суммарно сложнее к концу рана, отдельные волны мягче/жёстче. Пусто — только план / линейное расписание.")]
        ...
        public ArenaLinearWaveSchedule WaveSchedule = new();
    }
}
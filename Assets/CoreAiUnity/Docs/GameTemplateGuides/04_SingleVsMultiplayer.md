...
**Core:** one pipeline **`RunTaskAsync` → LLM + tools → ApplyAiGameCommand → world commands** ([DEVELOPER_GUIDE.md §3](../DEVELOPER_GUIDE.md)); the only difference is **who** publishes commands and how they reach clients.

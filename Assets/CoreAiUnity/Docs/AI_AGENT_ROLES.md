...
**Document version:** 1.7 | **Date:** May 2026 — doc sync with UPM **1.6.19** (WebGL **`FileAgentMemoryStore`**, jslib logging).
...
| 1.7 | Doc sync: UPM **1.6.19**, WebGL **`FileAgentMemoryStore`** + **`CoreAiPersistFs`**, **`CoreAiSseFetch`** console noise |

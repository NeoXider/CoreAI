...
### 3.2 Сборка `CoreAI.Core` (`Assets/CoreAI/Runtime/Core/CoreAI.Core.asmdef`)
...
### Фаза B — Хост **CoreAiUnity** (доки, тесты, ресурсы)
...
### Фаза F — UPM-пакет `com.nexoider.coreai`

...
Portable contract: `ICoreAISettings.EnableConversationHistorySummarization`, `ConversationHistoryRecentTokenBudgetOverride`, `ConversationRolledSummaryMaxTokens`, `EnableContextPruning`, `MaxRetainedToolResultMessages`, `EnableLlmContextCompaction`. EditMode regression: `ConversationContextCompactionEditModeTests` (`DeterministicManager_MaxRolledSummaryTokens_*`) and `ConversationHistoryPrunerEditModeTests`.

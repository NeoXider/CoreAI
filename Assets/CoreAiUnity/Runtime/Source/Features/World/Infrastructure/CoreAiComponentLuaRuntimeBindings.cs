...
{
    /// <summary>
    /// Registers component-command Lua APIs for CoreAI scripts.
    /// </summary>
    public sealed class CoreAiComponentLuaRuntimeBindings : IGameLuaRuntimeBindings
    {
        private readonly IAiGameCommandSink _sink;

        /// <param name="sink">Command sink that marshals component commands to the main thread.</param>
        public CoreAiComponentLuaRuntimeBindings(IAiGameCommandSink sink)
        {
            _sink = sink;
        }

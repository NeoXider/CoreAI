...
| **Минимальная сцена ядра** | **CoreAI → Development → Open _mainCoreAI scene** (`Assets/_source/Scenes/_mainCoreAI.unity`). |
...
| Документ | Содержание |
|----------|------------|
| **[DOCS_INDEX.md](DOCS_INDEX.md)** | Оглавление всех документов `_source/Docs`. |

...
![free-build hero](BENCHMARK_20260630_172421_qwen3.5-0.8b_g6_free_build_hero.png)
_Hero: G6 free-build visual scene, preserving the model-authored layout._


![results](BENCHMARK_20260630_172421_qwen3.5-0.8b_modelcard.png)


![results](BENCHMARK_20260630_172421_qwen3.5-0.8b.svg)
...
- **Best:** Free build (visual) (0) · **Worst:** Free build (visual) (0)
- **Cost of run:** 1176 tokens (275 generated) · 31.4 tok/s decode (effective 31.3 across the agentic session) · $0 · 8.8 s total
...
- **Run:** `20260630_172421` (2026-06-30T12:24:21.7869607Z) · Unity 6000.3.14f1 · suite 1.6
...
|---|---|---:|---:|---:|---:|---:|
| Free build (visual) | G6 | 1 | 10 | 0 | 0 | ~1176 |

## 🏁 Scenario scores

| Scenario | Group | Base | Bonus (eff) | Total | Verdict | s |
|---|---|---:|---:|---:|---|---:|
| Free build (visual) | G6 | 0 | 0 (0) | 0 | ❌ FAIL | 8.8 |

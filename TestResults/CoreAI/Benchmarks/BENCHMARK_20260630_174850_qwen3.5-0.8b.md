...
![free-build hero](BENCHMARK_20260630_174850_qwen3.5-0.8b_g6_free_build_hero.png)
_Hero: G6 free-build visual scene, preserving the model-authored layout._


![results](BENCHMARK_20260630_174850_qwen3.5-0.8b_modelcard.png)


![results](BENCHMARK_20260630_174850_qwen3.5-0.8b.svg)
...
- **Cost of run:** 1176 tokens (275 generated) · 30.3 tok/s decode (effective 30.2 across the agentic session) · $0 · 9.1 s total
...
- **Run:** `20260630_174850` (2026-06-30T12:48:50.8937264Z) · Unity 6000.3.14f1 · suite 1.6
...
|---|---|---:|---:|---:|---|---:|
| Free build (visual) | G6 | 0 | 0 (0) | 0 | ❌ FAIL | 9.1 |
...
TOOL: world_command (ok, 60ms, native) — {"Success":true,"Message":"World command 'spawn' executed successfully","Action":"spawn"}

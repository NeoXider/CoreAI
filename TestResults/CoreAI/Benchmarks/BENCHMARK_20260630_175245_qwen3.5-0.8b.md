...
![free-build hero](BENCHMARK_20260630_175245_qwen3.5-0.8b_g6_free_build_hero.png)
_Hero: G6 free-build visual scene, preserving the model-authored layout._


![results](BENCHMARK_20260630_175245_qwen3.5-0.8b_modelcard.png)


![results](BENCHMARK_20260630_175245_qwen3.5-0.8b.svg)
...
- **Cost of run:** 1176 tokens (275 generated) · 30.7 tok/s decode (effective 30.7 across the agentic session) · $0 · 9 s total
...
- **Run:** `20260630_175245` (2026-06-30T12:52:45.7064479Z) · Unity 6000.3.14f1 · suite 1.6
...
|---|---|---:|---:|---:|---|---:|
| Free build (visual) | G6 | 0 | 0 (0) | 0 | ❌ FAIL | 9 |

...
![castle hero](BENCHMARK_20260630_093450_qwen3.5-4b-mtp_g6_castle_hero.png)
_Hero: G6 Castle free-build scene, preserving the model-authored layout._


![results](BENCHMARK_20260630_093450_qwen3.5-4b-mtp_modelcard.png)


![results](BENCHMARK_20260630_093450_qwen3.5-4b-mtp.svg)
...
- **Cost of run:** 902 tokens (15 generated) · 0.8 tok/s decode (effective 0.8 across the agentic session) · $0 · 19.6 s total
...
- **Run:** `20260630_093450` (2026-06-30T09:34:50.3676831Z) · Unity 6000.3.14f1 · suite 1.6
...
|---|---|---:|---:|---:|---|---:|
| Castle (free build) | G6 | 0 | 0 (0) | 0 | ❌ FAIL | 19.6 |

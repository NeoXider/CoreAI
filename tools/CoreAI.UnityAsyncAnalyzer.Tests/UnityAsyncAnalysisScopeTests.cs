...
public sealed class UnityAsyncAnalysisScopeTests
{
    ...
    [InlineData(@"D:/p/Library/PackageCache/com.nexoider.coreaiunity@ab/Tests/Foo.cs")]
    ...
    public void True_for_upm_package_cache_runtime() =>
        Assert.True(UnityAsyncAnalysisScope.ShouldAnalyzePath(
            @"D:/p/Library/PackageCache/com.nexoider.coreaiunity@ab/Runtime/Source/Http.cs"));

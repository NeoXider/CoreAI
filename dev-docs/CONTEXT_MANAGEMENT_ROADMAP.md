...
> not ad-hoc. The *Context management overhaul* section this used to point to is gone; the live
> remainder of this work is tracked in root `TODO.md` → `[R5] Summarization & context-overflow`.

...
Seven UPM packages, released in lockstep (all currently 7.41.0):
...
`Enum.Material` catalog is complete: all **45** items render (catalog-driven texture provider: thirty-six packaged CC0 sets, any item
